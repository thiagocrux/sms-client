...
export default function Navigation() {
  ...
  return (
    <nav className={style.navigation}>
      ...
      <div className={style['div-container']}>
        <NavLink exact to="/patients" className={style.link} activeStyle={activeStyle}>
          <PeopleFill className={style.icon} />
          Pacientes
        </NavLink>
      </div>
      <div className={style['div-container']}>
        <NavLink exact to="/notifications" className={style.link} activeStyle={activeStyle}>
          <JournalMedical className={style.icon} />
          Notificações
        </NavLink>
      </div>
      <div className={style['div-container']}>
        <NavLink exact to="/reports" className={style.link} activeStyle={activeStyle}>
